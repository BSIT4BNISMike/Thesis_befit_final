...
class _D33rdweekState extends State<D33rdweek> {
  ...
  List<Reference> russianTwistFeedback = [];
  List<Reference> extensionsFeedback = [];
  List<Reference> prisonerSquatsFeedback = [];
  List<Reference> pushUpsFeedback = [];
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => MountainClimbers(week: week,
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => RussianTwist(week: week, feedbackFiles: russianTwistFeedback),
                                        ),
                                      );
                                    },
                                  ),
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Extension(week: week, feedbackFiles: extensionsFeedback),
                                        ),
                                      );
                                    },
                                  ),
                                  ...
                                  child: IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => PushUps(week: week, feedbackFiles: pushUpsFeedback),
                                        ),
                                      );
                                    },
                                  ),
